...
This repository contains my submission for the "Release Manager" Roleplay assignment for the SDLC & DevOps Fundamentals course. 
...
Here is an in-depth explanation of why CI/CD is critical for the "Smart-Attend" app:
